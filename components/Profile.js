            ...
            <div className="container mx-auto">
                ...
                <div className="flex lg:items-center md:items-start lg:w-10/12 w-full mt-14 mx-auto flex-wrap">
                    ...
                    <div className="md:w-[56.5%] hp:w-full px-10 hp:py-10 md:py-0">
                        ...
                        <p className="text-lg mt-5 leading-relaxed">Aliquam a fringilla metus. Fusce ut tortor ut sem sagittis convallis. Morbi et augue sed nisl fermentum dictum eget ut nisl. Mauris ut dolor posuere augue porta lobortis nec sed lacus. Curabitur dignissim ac lorem in tempor. Morbi id dui quis ex malesuada mattis. Suspendisse potenti. Nulla euismod diam ut risus mollis, id vehicula nulla dictum.</p>
                    </div>
                </div>
            </div>
        </section>
